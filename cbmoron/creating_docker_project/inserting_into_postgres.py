...
def getting_sql_query(ti,table):
...
def teams_match_stats_insert_data(ti):
    query, params=getting_sql_query(ti,'teams_matches_stats')
    print(query, params)
...
def match_partials_insert_data(ti):
    query, params=getting_sql_query(ti,'match_partials')
    print(query, params)
    SQLExecuteQueryOperator(
        task_id="upload_to_postgres",
        conn_id="cbmoron_postgres",
...
def shootings_insert_data(ti):
    query, params=getting_sql_query(ti,'shootings')
    print(query, params)
    SQLExecuteQueryOperator(
        task_id="upload_to_postgres",
        conn_id="cbmoron_postgres",
