...
def match_day(ti):
    ...
    ti.xcom_push(key='match_id',value=match_id)
    ti.xcom_push(key='data_mongo',value=data)
    ti.xcom_push(key='match_partials',value=match_partials)
    ti.xcom_push(key='players_matches_stats',value=players_matches_stats)
    ti.xcom_push(key='teams_matches_stats',value=teams_match_stats)
    ti.xcom_push(key='shootings',value=shooting_df)
    ti.xcom_push(key='shooting_chart_availability',value=shooting_charts_availability)
    #driver.quit()
    return match_id,data,match_partials,players_matches_stats,teams_match_stats,shooting_df,shooting_charts_availability
