...
def new_results(ti):
    ...
    #{"Jornada 8": "15/11/2024", "Jornada 9": "01/12/2024", "Jornada 10": "06/12/2024", "Jornada 11": "10/12/2024", "Jornada 12": "15/12/2024", "Jornada 13": "20/12/2024", "Jornada 14": "29/12/2024", "Jornada 15": "03/01/2025", "Jornada 16": "10/01/2025", "Jornada 17": "17/01/2025", "Jornada 18": "31/01/2025", "Jornada 19": "07/02/2025", "Jornada 20": "11/02/2025", "Jornada 21": "15/02/2025", "Jornada 22": "02/03/2025", "Jornada 23": "07/03/2025", "Jornada 24": "11/03/2025", "Jornada 25": "16/03/2025", "Jornada 26": "21/03/2025", "Jornada 27": "28/03/2025", "Jornada 28": "04/04/2025", "Jornada 29": "11/04/2025", "Jornada 30": "18/04/2025", "Jornada 31": "22/04/2025", "Jornada 32": "27/04/2025", "Jornada 33": "02/05/2025", "Jornada 34": "09/05/2025"}
    print(os.path.join(os.path.dirname(__file__), 'dates_primera.txt'))
    file_path = os.path.join(os.path.dirname(__file__), 'dates_primera.txt')
        ...
        for a in range(1,len(options)+1):
            ...
            if date in dates_to_scrape:
                ...
                if result:
                    ...
                    ti.xcom_push(key='trigger_evaluator_primera',value=True)
                    driver.quit()
                    return True

        driver.quit()
    ti.xcom_push(key='trigger_evaluator_primera',value=False)
    return False
