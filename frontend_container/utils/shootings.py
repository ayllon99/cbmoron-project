...
def draw_court(ax, color="black", lw=1, outer_lines=True):
    # Basketball Hoop
...
def process_dict_stats(dic_stats, year):
    try:
        ...
        right_corner_three_total = f"""{
            dic_stats[year]['Right Corner Three']['in']}/\
            {dic_stats[year]['Right Corner Three']['tried']}""".replace(' ','')
    ...
    try:
        ...
        right_corner_middle_total = f"""{
            dic_stats[year]['Right Corner Middle']['in']}/\
            {dic_stats[year]['Right Corner Middle']['tried']}""".replace(' ','')
    ...
    try:
        ...
        left_corner_middle_total = f"""{
            dic_stats[year]['Left Corner Middle']['in']}/\
            {dic_stats[year]['Left Corner Middle']['tried']}""".replace(' ','')
...
def adding_stats_to_display(ax, stats_to_display):
    # Zone
    ax.text(0, 60, stats_to_display['zone'], ha="center", va="center", fontsize=10)
    ax.text(0, 40, stats_to_display['zone_total'], ha="center", va="center", fontsize=10)
    # Front Middle
    ax.text(0, 185, stats_to_display['front_middle'], ha="center", va="center", fontsize=10)
    ax.text(0, 165, stats_to_display['front_middle_total'], ha="center", va="center",
            fontsize=10)
    # Right Side Middle
    ax.text(145, 140, stats_to_display['right_side_middle'], ha="center", va="center",
            fontsize=10)
    ax.text(145, 120, stats_to_display['right_side_middle_total'], ha="center", va="center",
            fontsize=10)
    # Left Side Middle
    ax.text(-145, 140, stats_to_display['left_side_middle'], ha="center", va="center",
            fontsize=10)
    ax.text(-145, 120, stats_to_display['left_side_middle_total'], ha="center", va="center",
            fontsize=10)
    # Left Corner Middle
    ax.text(-150, 20, stats_to_display['left_corner_middle'], ha="center", va="center",
            fontsize=10)
    ax.text(-150, 0, stats_to_display['left_corner_middle_total'], ha="center", va="center",
            fontsize=10)
    # Right Corner Middle
    ax.text(150, 20, stats_to_display['right_corner_middle'], ha="center", va="center",
            fontsize=10)
    ax.text(150, 0, stats_to_display['right_corner_middle_total'], ha="center", va="center",
            fontsize=10)
    # Front Three
    ax.text(0, 280, stats_to_display['front_three'], ha="center", va="center", fontsize=10)
    ax.text(0, 260, stats_to_display['front_three_total'], ha="center", va="center",
            fontsize=10)
    # Right Side Three
    ax.text(210, 180, stats_to_display['right_side_three'], ha="center", va="center",
            fontsize=10)
    ax.text(210, 160, stats_to_display['right_side_three_total'], ha="center", va="center",
            fontsize=10)
    # Left Side Three
    ax.text(-210, 180, stats_to_display['left_side_three'], ha="center", va="center",
            fontsize=10)
    ax.text(-210, 160, stats_to_display['left_side_three_total'], ha="center", va="center",
            fontsize=10)
    # Left Corner Three
    ax.text(-280, 0, stats_to_display['left_corner_three'], fontsize=10)
    ax.text(-280, -20, stats_to_display['left_corner_three_total'], fontsize=10)
    # Right Corner Three
    ax.text(230, 0, stats_to_display['right_corner_three'], fontsize=10)
    ax.text(230, -20, stats_to_display['right_corner_three_total'], fontsize=10)

    return ax


def set_look(ax, fig, year, found):
...
def generate_image(dic_stats=None, year=None):
    plt.close('all')
    fig, ax = plt.subplots()
